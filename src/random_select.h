/*
  Fairy-Random, a UCI chess variant random mover derived from Fairy-Stockfish
  Copyright (C) 2021 Ada Joule

  Fairy-Random is free software: you can redistribute it and/or modify
  it under the terms of the GNU General Public License as published by
  the Free Software Foundation, either version 3 of the License, or
  (at your option) any later version.

  Fairy-Random is distributed in the hope that it will be useful,
